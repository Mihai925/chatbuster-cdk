...
export class ComputeConstruct extends Construct {
  ...
  constructor(scope, id, props) {
    ...
    const { vpc, dbInstance, dbSecurityGroup, secrets, certificate } = props;
    ...
    // Configure Instance Refresh for zero-downtime deployments
    const cfnAsg = this.asg.node.defaultChild;
